...
class test_psl_entry(QCASTestClient):      
    ...
    def test_one_game_with_specific_seed(self): 
        ...
        #### Change this ####
        game_ssan_l = [ 168124 ]        # to add more games, add comma separated values here of SSANs. 
        test_seed_idx = 8               # note: zero based index, so 0=1 and 9=10, i.e. plus 1.
        ######################
        ...
        # assert(len(tsl_game_l) == len(game_ssan))
        ...
        for test_game in tsl_game_l: 
            for msl in msl_file_list: 
                ...
                test_seed = mslfile[0].seed_list[test_seed_idx]              
